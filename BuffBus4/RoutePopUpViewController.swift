...
class RoutePopUpViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        case 4:
            infoText.text = "The Late Night Silver route runs down broadway on Thursday Friday Saturday and Sunday from 8pm to 2am. Very similar to the Late Night Silver"
        case 6:
